  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "vant-login-wave-drift-1": "vant-login-wave-drift-1 11s ease-in-out infinite",
        "vant-login-wave-drift-2": "vant-login-wave-drift-2 14s ease-in-out infinite",
        "vant-login-wave-drift-3": "vant-login-wave-drift-3 9.5s ease-in-out infinite",
        "vant-login-wave-aurora": "vant-login-wave-aurora 7s ease-in-out infinite",
      },
    },
  },
